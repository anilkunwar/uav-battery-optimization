...
#   - NEW: Compute Efficiency Monitor (tracemalloc + psutil)
#   - NEW: Dynamic Initial Domain Sketch
# =============================================================================
...
# -----------------------------------------------------------------------------
# 8.5 Domain Sketch Function (NEW)
# -----------------------------------------------------------------------------
...
if operation_mode == "Run New Simulation":
    ...
    # --- DOMAIN SKETCH ---
    st.subheader("📐 Initial Domain Sketch (X-Z Plane)")
    sketch_params = {
        'Lx': Lx, 'Ly': Ly, 'Lz': Lz,
        'Nx': Nx, 'Ny': Ny, 'Nz': Nz,
        'T_amb': T_amb, 'trigger_radius': trigger_radius
    }
    fig_sketch = plot_initial_domain_sketch(sketch_params)
